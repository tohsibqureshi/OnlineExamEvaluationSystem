...
<title>Online Exam Evaluation System</title>
<!-- MDB icon -->
		...
		<header>
			...
			<nav
				...
				<div class="container">
					...
					<!-- Navbar brand -->
					<a class="navbar-brand" href="#">Online Exam Evaluation System</a>
						...
						<div class="col-lg-7 col-md-12">
							...
							<div class="row text-center">
								...
								<div class="col-lg-4 col-md-12 mb-3">
									...
									<p>
										<i class="fa fa-map fa-1x mr-2 grey-text"></i>India, Indore
										452001
									</p>
								...
								<div class="col-lg-4 col-md-6 mb-3">
									...
									<p>
										<i class="fa fa-phone fa-1x mr-2 grey-text"></i>+ 91 798 700
										5757
									</p>
